...
public class SomeClassEditor : Editor
{
    ...
    private SerializedProperty playerName, speed, playerPosition, playerPrefabs;
    ...
    public override void OnInspectorGUI()
    {
        ...
        source.playerPrefabs = (GameObject)EditorGUILayout.ObjectField
                (source.playerPrefabs, typeof(GameObject), true);
